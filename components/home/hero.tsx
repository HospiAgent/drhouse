      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
          <div className="flex flex-col justify-center space-y-4">
            <div className="inline-block rounded-lg bg-muted border border-primary px-3 py-1 text-sm text-primary w-fit font-medium">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl">
              Dr.House AI streamlines clinical workflows by transcribing
              conversations, generating clinical notes, and providing instant
              access to medical research—all in one secure platform.
            </p>
