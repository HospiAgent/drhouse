...
export default function SignupPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to MedAssist AI. Let's set up your profile.",
      });
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start your MedAssist AI journey today"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Dr. Jane Smith" autoComplete="name" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
